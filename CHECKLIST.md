# AgentTrace - Implementation Checklist
...
<<<<<<< HEAD
### Pricing & Plans
- ✅ Developer tier (Free): guest-mode debugging with timeline, comparison, search, and public sharing
- ✅ Pro tier (Lifetime $59): OAuth login, 90-day private retention, API ingestion + SDKs, AI summaries, global search, and usage analytics
- 🚧 Team tier (Contact us): enterprise collaboration and governance roadmap
...
### Database Migration
- ⚠️ Schema needs to be run in Supabase SQL editor
...
4. **Git Repository** (Current Issue)
   - [ ] Remove `node_modules` from git history
   - [ ] Ensure `.gitignore` properly excludes dependencies
